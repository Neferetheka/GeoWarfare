...
public class Base64
{
	...
	{ -9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 0 - 8
			...
			-9, -9, -9, -9, -9, // Decimal 27 - 31
			-5, // Whitespace: Space
			-9, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 33 -
															// 44
	...
	{
		int len34 = len * 3 / 4;
		byte[] outBuff = new byte[2 + len34]; // Upper limit on size of
												// output
		int outBuffPosn = 0;
		...
		for (i = 0; i < len; i++)
		{
			...
			{ // White space Equals sign or better
				...
				{
					// An equals sign (for padding) must not occur at
					// position 0 or 1
					...
					if (sbiCrop == EQUALS_SIGN)
					{
						...
						{
							throw new Exception("padding byte '=' falsely signals end of encoded value "
									+ "at offset " + i);
						}
